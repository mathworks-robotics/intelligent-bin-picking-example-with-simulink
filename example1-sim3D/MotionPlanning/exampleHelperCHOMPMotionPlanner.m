...
env = exampleHelperGenerateCollisionEnviornmentInPlanner(targetFlag,binLength, binWidth, binHeight, binCenterPosition, binRotation, numObstacles, obstaclePose);
